						...
						<div class="controles_datos_reporte">
							...
							<table class="informacion">				
								...
								<tr>
									...
									<td>
										<input type="text" class="fecha_inicio elemento control_fecha control_periodo_fecha" placeholder="dd-mm-aaaa"/>
									</td>
								</tr>
								<tr>
									<td class="una_linea"> Fecha de cierre : </td>
									<td>
										<input type="text" class="fecha_cierre elemento control_fecha control_periodo_fecha" placeholder="dd-mm-aaaa"/>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td>
										<input type="number" min="1" max="4" class="horas_dia" placeholder="#"/>
									</td>
								</tr>
								<tr>
								...
								<div class="celda alineacion_vertical_arriba">
									<table class="datos_complementarios_reporte">
										<tr>
											...
											<td>
												<input type="number" min="1" class="numero_reporte" placeholder="#"/>
											</td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td>
												<input type="text" class="boleta" placeholder="20XXPPXXXX"/>
											</td>
										</tr>
										<tr>
											<td class="una_linea"> Correo electrónico : </td>
											<td>
												<input type="text" class="correo" placeholder="usuario@cuenta.xy"/>
											</td>
										</tr>
										<tr>
								...
								<div class="celda">
									<table class="datos_complementarios_reporte">
										...
										<tr>
											...
											<td>
												<input type="text" class="nombre_responsable" placeholder="Nombre"/> <br/> 
											</td>
										</tr>
										<tr>
											<td></td>
								...
								<div class="celda alineacion_vertical_medio">
									<table class="datos_complementarios_reporte">
										<tr>
											...
											<td>
												<input type="text" class="fecha_emision control_fecha" placeholder="dd-mm-aaaa"/>
											</td>
										</tr>
									</table>
								</div>
								<div class="celda">
									<table class="datos_complementarios_reporte">
										<tr>
											...
											<td>
												<input type="number" min="0" class="total_horas_acumuladas_anterior" placeholder="#"/>
											</td>
										</tr>
									</table>
								</div>
